...
<body>
    ...
    <div id="story-id" class="hidden">${todo.story.id}</div>
    <h1><spring:message code="label.todo.view.page.title"/></h1>
    <div class="well page-content">
        <h2 id="todo-title"><c:out value="${todo.title}"/></h2>
        <div>
        ...
        <div class="action-buttons">
            ...
            <a  href="/todo/delete/id=${todo.story.id},todoid=${todo.id}" id="delete" class="btn btn-primary"><spring:message code="label.delete.todo.link"/></a>
        </div>
    </div>
    <script id="template-delete-todo-confirmation-dialog" type="text/x-handlebars-template">
        <div id="delete-todo-confirmation-dialog" class="modal">
            ...
            <div class="modal-footer">
                ...
                <a id="delete-todo-button" href="/todo/delete/id=${todo.story.id},todoid=${todo.id}" class="btn btn-primary"><spring:message code="label.delete.todo.button"/></a>
            </div>
        </div>
    </script>
</body>
