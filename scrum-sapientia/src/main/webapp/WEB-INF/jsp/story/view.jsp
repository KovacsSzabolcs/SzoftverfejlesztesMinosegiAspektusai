    ...
    <div class="well page-content">
	    ...
	    <div id="todo-list" class="page-content">
	        <c:choose>
	            ...
	            <c:otherwise>
	                <c:forEach items="${ story.todos}" var="todo">
	                    <div class="well well-small">
	                        <a href="/todo/${todo.id}"><c:out value="${todo.id}:${todo.title}"/></a>
	                    </div>
	                </c:forEach>
	            </c:otherwise>
	        </c:choose>
        ...
        <div class="action-buttons">
            ...
            <a href="/todo/add/${story.id}" class="btn btn-primary"><spring:message code="label.add.todo.link"/></a>
